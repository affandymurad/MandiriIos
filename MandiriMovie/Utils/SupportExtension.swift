...
extension UIColor {
    ...
    static var hijau: UIColor {
        return UIColor(red: 0.00, green: 0.62, blue: 0.00, alpha: 1.00)
    }
    
    static var jingga: UIColor {
        UIColor(red: 0.93, green: 0.52, blue: 0.33, alpha: 1.00)
    }
