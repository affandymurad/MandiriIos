...
class ReviewPresenter: BasePresenter<ReviewDelegates> {
    var reviewList: [ReviewList] = []
    
    func getMovieReview(id: String){
        self.view.taskDidBegin()
        let endpoint = URL(string: "https://api.themoviedb.org/3/movie/\(id)/reviews?api_key=\(Config.shared.apiKey)")
...
protocol ReviewDelegates: BaseDelegate {
